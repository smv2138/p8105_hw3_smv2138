...
```
    ...
    ##   day_type day           n
    ##   <chr>    <chr>     <int>
    ## 1 weekday  Friday     7200
    ## 2 weekday  Monday     7200
    ## 3 weekday  Thursday   7200
    ## 4 weekday  Tuesday    7200
    ## 5 weekday  Wednesday  7200
    ## 6 weekend  Saturday   7200
    ## 7 weekend  Sunday     7200

groupby and summarize problem make sure day of the week is in the order
you want it to be Part 3 24 hours of activity looks like in each minute
in each day min on x activity count on y. color is day of the week
geom\_line might work better than a scatter
