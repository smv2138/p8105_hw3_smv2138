...
the January plot, arounf 1999, the average mean temp was below -10
degrees C with would be considered an outlier. Generally, however, most
of the mean temps lie between 10 and 30 degrees C.
...
From the violin plot we can see that a lot of the variability in
snowfall happened in 2010.
